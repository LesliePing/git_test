...
const menuList = [
  {"id":1,"parentId":null,"sort":0,"name":"仪表盘","href":"/index","icon":"fa fa-dashboard","children":[],
    "isShow":"1"},
  {"id":31,"parentId":null,"sort":1,"name":"项目","href":"/test/1","icon":"fa fa-upload","children":
    [
    ...
    ,"isShow":"1"},
  {"id":102,"parentId":null,"sort":3,"name":"BUG管理"","href":"/test/2","icon":"fa fa-download","children":
    [
